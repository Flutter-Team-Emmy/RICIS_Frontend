		...
		<div>
			...
			<div className='w-[90%] mx-auto my-[4rem]'>
				<h2 className='sf400 text-[1.25rem] leading-[30px]  text-[#00000084] '>
					...
					hard to know which sources to look at for relevant research. Sienna
					and her team needed a way to ​track dozens of different topics and
					trends in biopharma at the same time from a large range of source{" "}
					<br /> <br />
					...
					“Rather than being about a specific disease, we started getting asked
					about things like drug pricing, or the gene and cell therapy
