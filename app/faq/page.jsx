	...
	return (
		<MainLayout>
			<div className='mb-[6rem]'>
				<BgImgText isLoading={isLoading} header='FAQS' url={imgUrl} text='FREQUENTLY ASKED QUESTIONS' />
				<div className='w-[90%] mx-auto pt-[3rem] '>
					...
					{isLoading && <div className="w-[95%] bg-gray-200 mb-12 m-auto h-40 animate-pulse"></div>}
					<FAQ />
				</div>
			</div>
		</MainLayout>
