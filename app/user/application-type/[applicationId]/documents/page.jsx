...
const Documents = () => {
    ...
    for (let i = 0; i < files.length; i++) {
      ...
      if (file.size <= 10 * 1024 * 1024) {
        ...
        reader.onload = function (event) {
          ...
          if (isExist) {
            updateSingleDocument(selectedDoc, updatedSelectedDocFiles)
              .then(() => {
  ...
  const documentsNotEmpty = documents?.every((doc) => doc?.data !== 0);
