...
const CardCenter = ({ header, img, id, index, handleClick }) => {
  return (
    <MotionComponent
      as="div"
      variants={fadeInVariants("up", (index + 1) / 10, 0.5)}
      className="flex items-center flex-col justify-center bg-white rounded-t-[15px] px-[4px] pt-[4px] cursor-pointer"
      // onClick={handleClick}
    >
