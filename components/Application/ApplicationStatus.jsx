...
const ApplicationStatus = () => {
    return (
        <div className="space-y-4">
             <span className="font-bold text-[#46B038] pr-4">APPLICATION DETAILS:</span>
            ...
            {statusDetails.map((status, index) =>
             ...
             <button className="text-sm bg-[#46B038] text-white py-2 px-8 w-fit rounded-md">Next</button>
        </div>  
    )
};
